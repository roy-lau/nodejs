...
Blockly.Blocks.communicate = {};
Blockly.Constants.communicate = {};
Blockly.Constants.communicate.HUE = 0//'#3288dd';

Blockly.Blocks['requests_get'] = {
  init: function() {
    this.setColour(Blockly.Constants.communicate.HUE);
...
Blockly.Blocks['controls_repeat_ext'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "nextStatement": null,
      "colour": Blockly.Constants.loops.HUE,
...
Blockly.Constants.data.HUE = 170//'#5ec73d'//195;


Blockly.Blocks['series_create'] = {
  init: function() {
    this.setColour(Blockly.Constants.data.HUE);
  this.appendDummyInput("")
...
Blockly.Constants.dicts = {};
Blockly.Constants.dicts.HUE = 345;
...
Blockly.Blocks['dicts_create_with'] = {
    ...
    init: function () {
        this.setColour(Blockly.Constants.dicts.HUE);
        this.appendDummyInput("")
...
Blockly.Constants.factory = {};
Blockly.Constants.factory.HUE = "#777777"//65;

Blockly.Blocks.factory_from_import = {
  init: function() {
    this.setColour(Blockly.Constants.factory.HUE);
  this.appendDummyInput("")
        .appendField("from ")
...
Blockly.Constants.hardware = {};
Blockly.Constants.hardware.HUE = 40

Blockly.Blocks.hardware_arduino_start = {
    init: function () {
        this.setColour(Blockly.Constants.hardware.HUE);
        this.appendDummyInput("")
...
Blockly.Constants.lists.HUE = 260//'#70b234'//260;
...
Blockly.Blocks['lists_sort'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "inputsInline": true,
      "output": "List",
      "colour": Blockly.Constants.lists.HUE,
...
Blockly.Constants.math.HUE = 230//'#e49f16';
...
Blockly.Blocks.pins = {};
Blockly.Constants.pins = {};
Blockly.Constants.pins.HUE = 230;

Blockly.Blocks['pins_digital_write'] = {
   init: function() {
    this.setColour(Blockly.Constants.pins.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.set = {};
Blockly.Constants.set = {};
Blockly.Constants.set.HUE = 100;
...
Blockly.Blocks['set_create_with'] = {
   ...
   */
  init: function() {
    this.setColour(Blockly.Constants.set.HUE);
  this.appendDummyInput("")
  //don't need to specify the data type in Python
        // .appendField(new Blockly.FieldDropdown([[Blockly.DLMLY_MICROBIT_JS_TYPE_NUMBER, 'Array<number>'], [Blockly.DLMLY_MICROBIT_JS_TYPE_STRING, 'Array<string>'], [Blockly.DLMLY_MICROBIT_JS_TYPE_BOOLEAN, 'Array<boolean>']]), 'TYPE')
        // .appendField(' ')
...
Blockly.Blocks.storage = {};
Blockly.Constants.storage = {};
Blockly.Constants.storage.HUE = 0//'#5d69c5'//0;

Blockly.Blocks.storage_fileopen = {
  init: function() {
    this.setColour(Blockly.Constants.storage.HUE);
...
Blockly.Constants.system = {};
Blockly.Constants.system.HUE = 120;
...
Blockly.Constants.texts = {};
Blockly.Constants.texts.HUE = 160//'#9ec440'//160;
...
Blockly.Blocks['text'] = {
  ...
  init: function() {
    ...
    this.setColour(Blockly.Constants.texts.HUE);
    this.appendDummyInput()
        .appendField(this.newQuote_(true))
...
Blockly.Constants.tuple = {};
Blockly.Constants.tuple.HUE = 195//'#5ec73d'//195;
...
Blockly.Blocks['tuple_create_with'] = {
   ...
   */
  init: function() {
    this.setColour(Blockly.Constants.tuple.HUE);
  this.appendDummyInput("")
  //don't need to specify the data type in Python
        // .appendField(new Blockly.FieldDropdown([[Blockly.DLMLY_MICROBIT_JS_TYPE_NUMBER, 'Array<number>'], [Blockly.DLMLY_MICROBIT_JS_TYPE_STRING, 'Array<string>'], [Blockly.DLMLY_MICROBIT_JS_TYPE_BOOLEAN, 'Array<boolean>']]), 'TYPE')
        // .appendField(' ')
...
Blockly.Constants.turtle = {};
Blockly.Constants.turtle.HUE = 180;

Blockly.Blocks['turtle_create'] = {
  init: function() {
    this.setColour(Blockly.Constants.turtle.HUE);
  this.appendDummyInput("")
...
Blockly.Blocks.utility = {};
Blockly.Constants.utility = {};
Blockly.Constants.utility.HUE = 160;

Blockly.Blocks['raw_table'] = {
  // Container.
  init: function() {
    this.setColour(Blockly.Constants.utility.HUE);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.appendDummyInput()
...
Blockly.Constants.variables.HUE = 330//'#af5180'//330;
