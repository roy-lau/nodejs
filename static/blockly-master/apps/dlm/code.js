...
document.write('<script src="../blockly/msg/js/company/' + Code.LANG + '.js"></script>\n');
//document.write('<script src="../blockly/msg/js/company/language/dlm/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../blockly/apps/dlm/js/conf/theme.js?t=' + new Date().getTime() + '"></script>\n');
