...
client.generalBasicUrl(imageUrl).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
client.generalBasicUrl(imageUrl, options).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
// 调用身份证识别
client.idcard(idCardImg, idCardSide).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
// 带参数调用身份证识别
client.idcard(idCardImg, idCardSide, idCardOpt).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
// 调用银行卡识别
client.bankcard(bankCardImg).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
 ...
 */
var drivingLicenseImg = fs.readFileSync("assets/example.jpg").toString("base64");

 // 调用驾驶证识别
client.drivingLicense(drivingLicenseImg).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
var vehicleLicenseImg = fs.readFileSync("assets/example.jpg").toString("base64");

// 调用行驶证识别
client.vehicleLicense(vehicleLicenseImg).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
// 带参数调用行驶证识别
client.vehicleLicense(vehicleLicenseImg, vehicleLicenseOpt).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
...
// 带参数调用驾驶证识别
client.drivingLicense(drivingLicenseImg, options).then(function(result) {
    console.log(JSON.stringify(result));
}).catch(function(err) {
    // 如果发生网络错误
    console.log(err);
