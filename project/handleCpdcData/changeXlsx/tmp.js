...
class HandleXlsx {
    constructor() {
        ...
        // this.filterXlsx('./input/瑞金胰腺癌患者补录数据_2017-2018.6——整理.xlsx')
        // this.filterXlsx('./input/胰腺癌单病种数据元2018.1-2019.4——整理.xlsx')

        this.readFilePromise("./output/2.xlsx-source.json")
    ...
    saveXlsx(json) {
        ...
        // 导出 Excel
        XLSX.writeFile(wb, './output/3.toPattern.xlsx',{ cellDates: true });
    }
    /**
     * 获取基本信息，第一个 sheet 页
     ...
     */
    async xlsxToJson() {
        const workbook = XLSX.readFile('./output/1.filterXlsx.xlsx',{ cellDates: true });
        ...
        this.saveFile(JSON.stringify(jsonInsertPATIENT_NO, null, 2), "./output/2.xlsx-source.json")
    }
    /**
     * 获取表格中 sheet 的数据
     * @return {[type]} [description]
    ...
    filterXlsx(xlsxFileName) {
        ...
        // 导出 Excel
        XLSX.writeFile(wb, './output/1.filterXlsx.xlsx');
