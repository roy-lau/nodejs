    ...
    handleFollowUp() {
        ...
        xlsxData.forEach(row => {
        	...
        	if (row['随访日期']) {
                ...
                sql += `INSERT INTO PAT_FOLLOW_UP (SD_CODE,PATIENT_NO,FU_TIMES,FOLLOW_UP_DATE,FOLLOW_UP_MONTHS,FU_STATUS,FU_REASON,DISPLAY_ORDER) VALUES ('YXA_O','${row.PATIENT_NO}','${row.FU_TIMES}','${row['随访日期']}','${row.FOLLOW_UP_MONTHS}','1','${row['一般状况']}','${row.DISPLAY_ORDER}');\n`
        	}
        })
