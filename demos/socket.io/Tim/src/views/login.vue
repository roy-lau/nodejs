<template>
  <div class="login">
    <div class="box">
      <h1 class="title-text">TIMING</h1>
      <br /><br />
      <label for="user"
        >账号： <input type="text" id="user" placeholder="请输入账号" /> </label
      ><br /><br />
      <label for="pwd"
        >密码： <input type="text" id="pwd" placeholder="请输入密码" /> </label
      ><br /><br />
      <router-link to="/Chat" class="login-btn"> 登 录 </router-link>
      <p>
        <span @click="onOtherLogin" v-show="!isShow" class="other-login-cls"
          >第三方登录</span
        >
