module.exports = {
  ...
  sendHtml: {
    ...
    attachment: [
      // html类型
      {
        data: "<html><h2>html标题</h2><p>一段内容</p></html>",
        alternative: true,
      },
    ],
  },
  ...
  sendZip: {
    ...
    attachment: [
      ...
      {
        data:
          "<html><h2>zip邮件</h2><p>这是一个使用emailjs发送的带有压缩包的的邮件</p></html>",
        alternative: true,
      },
      // zip类型，附件
      // path 是相对于index.js的
      {
        path: "src/assets/test-send--by-zip-file.zip",
        type: "application/zip",
        name: "附件-压缩包.zip",
      },
      {
        path: "src/assets/imges.gif",
        type: "image/gif",
        name: "附件-图片.gif",
      },
    ],
  ...
  sendImg: {
    ...
    attachment: [
      ...
      {
        data:
          "<html><h2>image邮件</h2><p>这是一个使用emailjs发送的带有图片的邮件</p><img src='cid:my-image' width='100' height ='50'></html>",
        alternative: true,
      },
      // jpg 类型 附件
      // path 是相对于index.js的
